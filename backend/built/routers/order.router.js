...
var oredr_status_1 = require("../constants/oredr_status");
var auth_mid_1 = __importDefault(require("../midlewares/auth.mid"));
        ...
        switch (_a.label) {
            case 0:
                ...
                if (requestOrder.items.length <= 0) {
                    res.stattus(http_status_1.HTTP_BAD_REQUEST).send("Cart Is Empty!");
                    return [2 /*return*/];
                }
                return [4 /*yield*/, order_model_1.OrderModel.deleteOne({
                        user: req.user.id,
                        status: oredr_status_1.OrderStatus.NEW,
                    })];
            case 1:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                order.status = oredr_status_1.OrderStatus.PAYED;
